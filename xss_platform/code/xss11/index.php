<?php setcookie("cookie",'xss11'); ?>

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>xss11</title><!-- code by reber <1070018473@qq.com> -->
    ...
    window.alert = function() {
        if (confirm("成功，进入下一关")) {
            window.location.href="../xss12/index.php";
        }
    }
    </script>
</head>
<body>
    <h1 class="header">欢迎来到xss11</h1>
...
?>
    ...
    <div class="source">
        ...
        <button onclick="a_iframe(550,240,'tips.html','答案解析');">Tips</button>
    </div>
</body>
</html>